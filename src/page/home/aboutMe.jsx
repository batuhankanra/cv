...
export default function AboutMe() {
  return (
    <div className=" w-[300px]  sm:w-[680px] mx-auto mt-20 flex flex-col gap-y-3 text-lg ">
        <div className="py-5">
            <h3 className="text-lg font-semibold uppercase tracking-widest text-green-600 dark:text-green-400">About me</h3>
            <h1 className="text-2xl font-bold">Hello, my Name is Batuhan Kanra</h1>
        </div>
